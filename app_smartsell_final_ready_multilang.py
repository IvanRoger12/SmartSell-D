...
def t(key, lang):
    translations = {
        ...
        "Insights & Actions": {
            "fr": "Analyses & Actions",
            "en": "Insights & Actions",
            "es": "Perspectivas y Acciones",
            "it": "Approfondimenti e Azioni",
            "zh": "洞察与行动"
        },
        "Select Language": {
        ...
        # Ajoutez plus de clés ici selon besoin...
    }
    return translations.get(key, {}).get(lang, key)

lang = st.sidebar.selectbox("🌐 Select Language", ["fr", "en", "es", "it", "zh"], index=0)
# ===============================
